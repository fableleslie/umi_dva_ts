...
export default class Index extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log('this.props.onRef1');
    if (this.props.onRef) {
      console.log('this.props.onRef2');
  ...
  myUploadFn = param => {
    ...
    const serverURL = '/api/base-knowledge/knowledge/education/photo/upload'; // upload 是接口地址
    // /api/base-knowledge/knowledge/education/video/upload上传视频
  ...
  //       type: 'AUDIO',
  //       url:
  //         'http://10.20.222.231:8010/group1/M00/00/11/ChTe514JakiAEj98AGQkdnzzog8926.mp3',
  //     },
  //     {
  //       type: 'VIDEO',
  //       url:
  //         'http://10.20.222.231:8010/group1/M00/00/11/ChTe514JcAqAMA_pAA1n5PKxGxo750.mp4',
  //     },
  //   ]);
    ...
    return (
      <div className="braft-component">
        <BraftEditor
          ...
          excludeControls={[...excludeControls, ...excludes]}
